...
var SelfGrid = {
    ...
    create: function(caption, jqid, pager, colNames, colModels, onPagedown, onNew, onDelete, onUpdate, beforeUpdate, beforeAdd) {
        var obj = {
            grid: jQuery(jqid),
            load: SelfGrid.load,
            ...
            obj.grid.navButtonAdd(pager, {
                ...
                onClickButton: function() {
                    obj.grid.jqGrid('editGridRow', "new", {
                        ...
                        beforeShowForm: before_add_local
                    });
                },
                position: "last"
            });
            ...
            obj.grid.navButtonAdd(pager, {
                ...
                onClickButton: function() {
                    if (!obj.lastsel3) {
                        ...
                        var postdata = obj.grid.jqGrid('getRowData', obj.lastsel3);
                        if (obj.onDelete) {
